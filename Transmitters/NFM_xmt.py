...
class NFM_xmt(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.rs_ratio = rs_ratio = 1.045
        self.pl_freq = pl_freq = 0.0

        ##################################################
        # Blocks
        ##################################################
        self._volume_range = Range(0, 2.0, 0.1, 0.5, 200)
        ...
        self.top_grid_layout.addWidget(self._pl_freq_tool_bar, 1, 0, 1, 1)
        for r in range(1, 2):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.band_pass_filter_0.set_taps(firdes.band_pass(1, self.samp_rate, 200, 3000, 500, window.WIN_HAMMING, 6.76))
        self.low_pass_filter_0.set_taps(firdes.low_pass(0.5, self.samp_rate, 5000, 2000, window.WIN_HAMMING, 6.76))
        self.mmse_resampler_xx_0.set_resamp_ratio(1.0/((self.usrp_rate/self.samp_rate)*self.rs_ratio))
